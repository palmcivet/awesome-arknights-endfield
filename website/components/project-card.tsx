        ...
        {hasGithub ? (
          <>
            ...
            <a
              ...
              className="hidden max-w-full items-center gap-1.5 transition-colors hover:text-foreground/70 lg:inline-flex"
                  ...
                  {project.author.url ? (
                    <>
                      ...
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="hidden underline decoration-border underline-offset-2 transition-colors hover:text-foreground hover:decoration-foreground lg:inline"
                      >
                        {project.author.name}
                      </a>
                    </>
              ...
              {websites.map((site, i) => (
                <span key={i}>
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="hidden items-center gap-1 border border-transparent px-1.5 py-0.5 font-mono text-[10px] text-muted-foreground transition-colors hover:border-border hover:text-foreground lg:inline-flex"
